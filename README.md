...
- **Languages:** JavaScript, Golang, Python, Lua, etc.
- **Frameworks:** Laravel, React, Next.js, Node.js, etc.
- **Security Tools:** Burp Suite, Metasploit, Nmap, and more
- **Other Tools:** Git, Docker, Linux, VSCode

## 📢 Connect With Me

- 🌐 Website: [roomkangali.com](https://roomkangali.com/)
- 🐦 Twitter: [@roomkangali](https://twitter.com/roomkangali)
